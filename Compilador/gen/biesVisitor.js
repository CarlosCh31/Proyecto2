...
export default class biesVisitor extends antlr4.tree.ParseTreeVisitor {
	...
	// Visit a parse tree produced by biesParser#variableDeclaration.
	...
	// Visit a parse tree produced by biesParser#letInExpr.
	visitLetInExpr(ctx) {
	  return this.visitChildren(ctx);
	}


	// Visit a parse tree produced by biesParser#stmt.
	visitStmt(ctx) {
	  return this.visitChildren(ctx);
	}


	// Visit a parse tree produced by biesParser#constDeclaration.
